...
describe 'redirect', ->
  ...
  it 'can redirect to oauth server', ->
    ...
    expectedUrl = 'https://test.amp.monsanto.com/as/authorization.oauth2?response_type=code&client_id=abc123&redirect_uri=http%3A%2F%2Fmyhost%2Fmy%2Furl%2Freceive-auth-token&state=aHR0cDovL215aG9zdC9teS91cmw%3D'
